...
void BackgroundLayer::OnInit(Renderer2D& renderer, Shader& shader)
{
...
bool BackgroundLayer::OnEvent(const sp::events::Event& event)
{
	return false;
}

void BackgroundLayer::OnRender(Renderer2D& renderer)
{
